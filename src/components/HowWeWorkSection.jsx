...
const HowWeWorkSection = () => {
  ...
  return (
    <section id="how-we-work" className="bg-white py-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-20">
          ...
          <div className="relative">
            {/* Vertical Line */}
            <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-gradient-to-b from-red-600 via-red-500 to-red-600 rounded-full hidden lg:block" />
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`lg:w-5/12 ${isEven ? 'lg:pr-16 lg:text-right' : 'lg:pl-16 lg:text-left'}`}>
                      <div className="bg-gray-50 border border-gray-200 rounded-3xl p-8 hover:bg-red-50 hover:border-red-200 transition-all">
                        ...
                        <h4 className="text-gray-900 text-xl font-semibold mb-3">{step.title}</h4>
        ...
        {/* Key Benefits */}
        <div className="bg-gray-50 border border-gray-200 rounded-3xl p-8 md:p-12 mb-16">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8">
              <div className="text-center">
                ...
                <div className="text-gray-900 font-medium mb-4">Daha Hedefli Kitle</div>
        ...
        {/* CTA - Teklif Al */}
        <div className="text-center bg-gradient-to-r from-red-600 to-red-700 rounded-3xl p-12">

      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mt-4">
            ...
            <br />
            <span className="text-gray-500">Otoritesi Olmaya Devam Ediyor</span>
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, index) => {
            ...
            return (
              <div 
                key={index}
                className="group bg-[#242426] rounded-3xl p-8 hover:bg-[#2a2a2c] transition-all duration-300 cursor-pointer"
              >
                <div 
        ...
        {/* Info Box */}
        <div className="mt-16 bg-gradient-to-r from-[#d3f26a]/10 to-[#ad7bff]/10 rounded-3xl p-8 md:p-12">

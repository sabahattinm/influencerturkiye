...
/**
 * ApplicationPage - Üye Ol Sayfası
 * Bağımsız kayıt formu - Projenin işleyişinden bağımsız
 */
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-200">
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600 text-sm">
              ...
              <Link to="/iletisim" className="text-red-600 hover:text-red-700 font-semibold">
                İletişime Geçin
              </Link>
            </p>
          </div>
